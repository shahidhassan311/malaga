...
<div class="page-container">
        ...
        <ul class="x-navigation">
            <li class="xn-logo">
                @if(\Illuminate\Support\Facades\Auth::user()->role == "admin")
                    <a href="/property">{{ \Illuminate\Support\Facades\Auth::user()->name }}</a>
                @else
                @endif
            ...
            <li class="xn-profile">
                <a href="#" class="profile-mini">
                    <img src="{{ URL::to('/') }}/adminpanel/img/malagalogo.png" alt="John Doe"/>
                </a>
                <div class="profile">
                    <div class="profile-image">
                        <img src="{{ URL::to('/') }}/adminpanel/img/malagalogo.png" alt="John Doe" style="height: 120px;"/>
                    </div>
                    <div class="profile-data">
                        <div class="profile-data-name">Malaga Class</div>
                    </div>
            ...
            <li>
                <a href="/add_property"><span class="fa fa-desktop"></span> <span
                            class="xn-text">Add Property</span></a>
            </li>
        </ul>
        <!-- END X-NAVIGATION -->
    </div>
    ...
    <div class="page-content">
        ...
        <div class="page-title">
            <h2><span class="fa fa-arrow-circle-o-left"></span>Properties</h2>
        </div>
        <!-- END PAGE TITLE -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table datatable">
                                ...
                                <tbody>
                                @foreach($property_detail as $property_details)
                                    <tr>
                                        <td>{{ $property_details->property_id }}</td>
                                        <td>{{ $property_details->name }}</td>
                                        <td>{{ $property_details->location }}</td>
                                        <td>{{ $property_details->price_from }}</td>
                                        <td>{{ $property_details->property_sale_type }}</td>
                                        <td>{{ $property_details->property_type }}</td>
                                        <td>
                                            @if($property_details->status == "Active")
                                                <a href="/properties_status/{{ $property_details->id }}/{{ $property_details->status }}">
                                                    <button class="badge badge-success"
                                                            style="width: 58px;">{{ $property_details->status }}</button>
                                                </a>
                                            @else
                                                <a href="/properties_status/{{ $property_details->id }}/{{ $property_details->status }}">
                                        ...
                                        <td>
                                            <a href="/properties_detail/{{ $property_details->id }}">
                                                <button class="btn btn-default btn-rounded btn-sm" title="detail"><span
                                                            class="fa fa-book"></span></button>
                                            </a>
                                            <a href="/property_update_get/{{ $property_details->id }}">
                                                <button class="btn btn-default btn-rounded btn-sm" title="edit"><span
                                                            class="fa fa-pencil"></span></button>
                                            </a>
                                            <a href="/properties_delete/{{ $property_details->id }}">
                                                <button class="btn btn-danger btn-rounded btn-sm" title="delete"><span
...
<script type="text/javascript"
        src="{{ URL::to('/') }}/adminpanel/js/plugins/datatables/jquery.dataTables.min.js"></script>
